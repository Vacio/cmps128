...
#sched.add_job(gossip,'interval',seconds=1)
#sched.start()
...
def test_gossip():
    ...
    print(type(this_server))
    chosen = randint(0,len(this_server.view_node_list)-1)
    node_ip = this_server.view_node_list[chosen]
    print('CHOSEN VALUE FOR IP IS:'+ node_ip)
